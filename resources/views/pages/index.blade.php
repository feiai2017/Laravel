...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('css/swipebox.css')}}" />
...
<div class="panel panel-left panel-reveal">
    <nav class="sidebar-nav">
        <ul>
            ...
            <li><a href="tables.html" class="close-panel"><img src="images/icons/white/tables.png" alt="" title="" /><span>Tables</span></a></li>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="slider-caption">
                                    <h2 data-swiper-parallax="-100%">DR CHICKEN</h2>
                                    <span class="subtitle" data-swiper-parallax="-60%">FAST AND SMART</span>
                                    <p data-swiper-parallax="-30%">You can use this app to quickly and easily understand breeding techniques and make pathological diagnosis..</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
...
<script type="text/javascript" src="js/yangzhi.js"></script>
<script type="text/javascript" src="js/bingli.js"></script>
<script>
